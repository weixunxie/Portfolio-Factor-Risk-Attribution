    ...
    <div>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
          ...
          {/* Contact icon group */}
          <div style={{ display: "flex", gap: 18, alignItems: "center", paddingTop: 4, paddingRight: 6 }}>
            {/* GitHub */}
            <a
              href="https://github.com/weixunxie"
              target="_blank"
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/in/weixun-xie-0587202b0/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* Email */}
            <a
              href="mailto:weixunxie@outlook.com"
